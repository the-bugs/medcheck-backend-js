...
const consultaRoute = require("./consultas");
const auth = require('./auth');

module.exports = (app) => {
  app.use(
    bodyParser.json(),
    usuarioRoute, especialidadesRoute,
    adminRoute, pacienteRoute, medicoRoute,
    prontuarioRoute, agendaRoute, consultaRoute, auth
  );
